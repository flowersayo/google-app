...
const LeftBtn = styled.a`
  ...
  margin: 0 5px;
  margin-left: 15px;
  color: ${(props) => props.theme.leftBtnColor};
  background-color: ${(props) => props.theme.bgColor};
  font-size: 14px;
...
const RightBtn = styled.a`
  ...
  color: ${(props) => props.theme.rightBtnColor};
  background-color: ${(props) => props.theme.bgColor};
...
const GrayButton = styled.button`
  margin-right: 10px;
  background: ${(props) => props.theme.centerBtnBgColor};
  color: ${(props) => props.theme.centerBtnColor};
  border: none;
  outline: none;
  margin: 11px 4px;
  padding: 0 16px;
...
function App() {
  ...
  const dark = {
    ...
    leftBtnColor: "white",
    rightBtnColor: "white",
    centerBtnBgColor: "black",
    centerBtnColor: "white",
    footerBgColor: "black",
    footColor: "white",
  };
  ...
  const light = {
    bgColor: "white",
    leftBtnColor: "#202124",
    rightBtnColor: "#212121",
    centerBtnBgColor: "#f8f9fa",
    centerBtnColor: "#3c4043",
